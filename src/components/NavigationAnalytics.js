    ...
    let addMenuButtonsActiveClass = function() {        
        for (let i = 0; i < menuButtons.length; i++) {
            if(menuButtons[i].classList.contains(window.location.hash)) {
                currentActiveButton = menuButtons[i];
                currentActiveButton.classList.add('selected');    
                break;
            }       
        }                
    }           

    let removeMenuButtonsActiveClass = function () {        
        for (let i = 0; i < document.querySelectorAll('.nav-button').length; i++) {
            if(document.querySelectorAll('.nav-button')[i].classList.contains('selected')) {
                document.querySelectorAll('.nav-button')[i].classList.remove('selected');    
                break;
            }       
        }                
    } 
    ...
    return(
        <div className='navigation-analytics-wrapper'>
            <div className='nav-button-cont'>
                <div>
                    <Link onSetActive={removeMenuButtonsActiveClass} onContextMenu={(e)=>{e.preventDefault(); e.target.nextElementSibling.classList.add('open')}} spy={true} hashSpy={true} to='dashboard-body-analytics' className='nav-button nav-button-dashboard #dashboard-body-analytics'>Dashboard</Link>
                ...
                <div>
                    <Link onSetActive={removeMenuButtonsActiveClass} onContextMenu={(e)=>{e.preventDefault(); e.target.nextElementSibling.classList.add('open')}} spy={true} hashSpy={true} to='revenue-body-analytics' className='nav-button nav-button-revenue #revenue-body-analytics'>Revenue</Link>
                    <div className='custom-context-menu'>
                ...
                <div>
                    <Link onSetActive={removeMenuButtonsActiveClass} onContextMenu={(e)=>{e.preventDefault(); e.target.nextElementSibling.classList.add('open')}} spy={true} hashSpy={true} to='demography-body-analytics' className='nav-button nav-button-demography #demography-body-analytics'>Demography</Link>
                    <div className='custom-context-menu'>
                ...
                <div>
                    <Link onSetActive={removeMenuButtonsActiveClass} onContextMenu={(e)=>{e.preventDefault(); e.target.nextElementSibling.classList.add('open')}} spy={true} hashSpy={true} to='circulation-body-analytics' className='nav-button nav-button-circulation #circulation-body-analytics'>Circulation</Link>
                    <div className='custom-context-menu'>
                ...
                <div>
                    <Link onSetActive={removeMenuButtonsActiveClass} onContextMenu={(e)=>{e.preventDefault(); e.target.nextElementSibling.classList.add('open')}} spy={true} hashSpy={true} to='hrm-metrics-body-analytics' className='nav-button nav-button-hrm-metrics #hrm-metrics-body-analytics'>HRM Metrics</Link>
                    <div className='custom-context-menu'>
                ...
                <div>
                    <Link onSetActive={removeMenuButtonsActiveClass} onContextMenu={(e)=>{e.preventDefault(); e.target.nextElementSibling.classList.add('open')}} spy={true} hashSpy={true} to='estimate-values-body-analytics' className='nav-button nav-button-estimate-values #estimate-values-body-analytics'>Estimate Values</Link>
                    <div className='custom-context-menu'>
